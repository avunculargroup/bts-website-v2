  ...
  const contactItems = [
    {
      ...
      content: (
        <a href='mailto:enquiry@btreasury.com.au' className='link-hover-gold'>
    ...
    },
    {
      ...
      content: (
        <Link
          ...
          className='inline-flex items-center gap-1 link-hover-gold'
        >
          Book a time
          ...
          <div className='grid gap-8 md:grid-cols-2'>
            ...
            <div className='space-y-6'>
              ...
              <div className='space-y-4'>
                {contactItems.map(({ label, iconPath, content }) => (
